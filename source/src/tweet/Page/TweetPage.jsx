        ...
        <div className="container">
            <div className="row">
                <div className="col-md-8 pl-0 pr-0">
                    <img className="img-fluid" alt={props.tweet.title} src={process.env.REACT_APP_IMAGE_URL + props.tweet.slug + "/size2.jpg"}/>
                    ...
                    <a className="btn btn-info btn-block " target={"_blank"} href={props.tweet.twitter_content.url}>jump to the
                        article</a>
                </div>
                <div className="col-md-4 pl-0 pr-0">
                    <AppTweetRelation categorylist={props.categoryList} />
                </div>
            </div>
        </div>
    )
